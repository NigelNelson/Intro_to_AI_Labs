...
class Room:
    ...
    def add_single_direction_neighbor(self, r, d: Direction) -> None:
        """Adds one-way passage to neighbor in given direction."""
    ...
    def add_neighbor(self, r, d: Direction) -> None:
        """Adds two-way passage to neighbor in the given direction, where 
        the passage back is in the opposite direction of the passage there."""
