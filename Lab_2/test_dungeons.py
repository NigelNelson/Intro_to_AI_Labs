#
# test_dungeons.py: creates various dungeon configurations and provides
...
def test_rat_2(debug: bool = False) -> str:
    """Test a rat going from the start to the end of the rat/dungeon constructed
...
def test_rat_3(debug: bool = False) -> str:
    """Test a rat going from the start to the end of the rat/dungeon constructed
...
def test_rat_4(debug: bool = False) -> str:
    ...
    path = rat.directions_to(impossible_goal)
    assert len(path) == 0
...
def test_rat_5(debug: bool = False) -> str:
...
def test_rat_6(debug: bool = False) -> str:
...
def test_rat_7(debug: bool = False) -> str:
...
def main() -> int:
    ...
    result.
    """
    n = int(input("Enter test number (1-7; 0 = run all): "))
    ...
    if n == 0:
        ...
        result = test_rat_1(debug)
    elif n == 2:
        result = test_rat_2(debug)
    elif n == 3:
        result = test_rat_3(debug)
    elif n == 4:
        result = test_rat_4(debug)
    elif n == 5:
        result = test_rat_5(debug)
    elif n == 6:
